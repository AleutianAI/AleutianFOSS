...
// NewOpenAIClient creates an OpenAI client from environment variables.
//
// Description:
//
//	Reads OPENAI_API_KEY, OPENAI_MODEL, and OPENAI_BASE_URL from environment.
//	OPENAI_BASE_URL enables use with any OpenAI-compatible provider (Groq,
//	Mistral, DeepSeek, vLLM, LM Studio, Together AI) by pointing to their
//	chat completions endpoint.
//
// Inputs:
//   - OPENAI_API_KEY (required): API key for authentication.
//   - OPENAI_MODEL (optional): Model name, defaults to "gpt-4o-mini".
//   - OPENAI_BASE_URL (optional): Chat completions endpoint URL, defaults
//     to "https://api.openai.com/v1/chat/completions".
//
// Outputs:
//   - *OpenAIClient: The configured client.
//   - error: Non-nil if API key is missing.
//
// Thread Safety: The returned client is safe for concurrent use.
func NewOpenAIClient() (*OpenAIClient, error) {
	...
	slog.Info("Initializing OpenAI client", "model", model, "base_url", baseURL)
	return &OpenAIClient{
		httpClient: &http.Client{Timeout: 120 * time.Second},
		apiKey:     apiKey,
		model:      model,
...
// Description:
//
//	Converts agenttypes.Message to OpenAI format and sends a chat completion
...
func (o *OpenAIClient) Chat(ctx context.Context, messages []agenttypes.Message, params GenerationParams) (string, error) {
	model := o.model
...
func (o *OpenAIClient) ChatStream(ctx context.Context, messages []agenttypes.Message,
