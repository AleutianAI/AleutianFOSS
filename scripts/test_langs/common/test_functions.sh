...
run_extra_check() {
    ...
    case "$check" in
        ...
        analytics_recorded)
            ...
            local trace=$(ssh_cmd "curl -s 'http://localhost:12217/v1/trace/agent/$session_id/reasoning'" 2>/dev/null)
        ...
        generation_incremented)
            ...
            local gen_response=$(ssh_cmd "curl -s 'http://localhost:12217/v1/trace/debug/crs/generation'" 2>/dev/null)
        ...
        cache_miss_expected)
            ...
            local cache_stats=$(ssh_cmd "curl -s 'http://localhost:12217/v1/trace/debug/cache'" 2>/dev/null || echo "{}")
